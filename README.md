...
- Hero: Workflow & Data System Designer 중심의 첫 화면. 모든 주요 섹션은 page rolling 구조로 표시
...
- Stack: Analysis / Modeling을 포함한 기술·업무 역량. carousel 안에서 직접 사용 항목과 AI-assisted 표현을 구분
- Contact: Google Form URL이 등록된 경우에만 표시
